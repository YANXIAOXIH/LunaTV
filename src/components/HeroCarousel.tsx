    ...
    const fetchAllData = async () => {
      try {
        const [movies, tvs, animes, shows] = await Promise.all([
          getDoubanCategories({ kind: 'movie', category: '热门', type: '全部', limit: 3 }),
          getDoubanCategories({ kind: 'tv', category: '热门', type: '热门', limit: 3 }),
          getDoubanCategories({ kind: 'tv', category: '日本', type: '动画', limit: 3 }),
          getDoubanCategories({ kind: 'tv', category: '热门', type: '综艺', limit: 3 }),
        ]);
